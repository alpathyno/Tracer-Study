...
@section('content')
<h4 class="mb-4">{{ $tracer ? 'Edit' : 'Isi' }} Tracer Study</h4>
...
<div class="card">
    <div class="card-body">
        <form method="POST" action="{{ $tracer ? route('tracer.update') : route('tracer.store') }}">
            @csrf
            @if($tracer)
                @method('PUT')
            @endif
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <small class="text-muted">Berapa lama sejak lulus hingga mendapat pekerjaan/menerima offer.</small>
                </div>
                <div class="col-md-6 mb-3">
            ...
            <div class="mb-4">
                <label for="feedback" class="form-label">feedback/Saran untukSekolah</label>
